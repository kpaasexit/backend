...
public enum UserErrorCode implements ErrorCode {
    ...
    INVALID_REFRESH_TOKEN("AUTH_ERR_0013", HttpStatus.BAD_REQUEST, "올바르지 않은 리프레시 토큰입니다."),
    EXPIRED_REFRESH_TOKEN("AUTH_ERR_0014", HttpStatus.UNAUTHORIZED, "만료된 리프레시 토큰입니다."),
